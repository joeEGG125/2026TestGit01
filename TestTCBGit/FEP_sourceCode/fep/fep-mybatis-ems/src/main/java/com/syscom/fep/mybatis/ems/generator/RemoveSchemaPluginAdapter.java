...
public class RemoveSchemaPluginAdapter extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        if (StringUtils.isNotBlank(schema)) {
            ...
            searchString = StringUtils.join(Arrays.asList(schema, MybatisConstant.REPLACE_TABLE_NAME_FOR_FEPLOG1_INCLUDE_REFID), ".");
            this.removeSchema(document.getRootElement(), MybatisConstant.REPLACE_TABLE_NAME_FOR_FEPLOG1_INCLUDE_REFID, searchString);
        }
        return true;
    }
