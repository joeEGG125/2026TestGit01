...
public class SimpleNettyEventExecutorChooserFactory {

    public static final SimpleNettyEventExecutorChooserFactory INSTANCE = new SimpleNettyEventExecutorChooserFactory();

    private SimpleNettyEventExecutorChooserFactory() {}
