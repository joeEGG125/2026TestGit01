...
/**
 * 發送Restful請求給FEP FISC
 *
 * @author Richard
 */
public class ToFEPFISCRestfulClient extends RestfulClient<BaseCommu, String> {

    public ToFEPFISCRestfulClient(String uri) {
        super(uri);
    }
    ...
    protected String getURI() {
        ...
        // 如果沒有塞值，則返回預設的url
        return StringUtils.isBlank(uri) ? "http://localhost:8080/recv/fisc" : uri;
    }

    @Override
    protected String getName() {
        return ClientType.TO_FEP_FISC.name();
    }
}