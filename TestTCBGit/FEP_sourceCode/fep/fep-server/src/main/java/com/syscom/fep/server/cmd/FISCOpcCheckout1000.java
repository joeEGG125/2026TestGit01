...
public class FISCOpcCheckout1000 extends Command {

    public static void main(String[] args) {
        new FISCOpcCheckout1000().execute(args);
    }
    ...
    protected void displayUsage() {
        ...
        System.out.println(" FISCOpcCheckout1000 Options");
        System.out.println();
        ...
        System.out.println(" FISCCmdOpcCheckout1000 /Host:127.0.0.1 /Port:8101 /KeyId:04");
    }
    ...
    protected void process(String[] args) throws Exception {
        ...
        String result = this.httpPost("http://" + host + ":" + port + "/opc/checkout1000", new String[] {"keyId=" + keyId, "operator=" + operator});
