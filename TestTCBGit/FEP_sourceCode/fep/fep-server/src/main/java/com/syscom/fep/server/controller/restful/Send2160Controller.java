...
@StackTracePointCut(caller = SvrConst.SVR_2160)
public class Send2160Controller extends BaseController {

    @Override
    public String getName() {
        return SvrConst.SVR_2160;
    }

    @RequestMapping(value = "/recv/send2160", method = RequestMethod.POST, produces = MediaType.APPLICATION_XML_VALUE)
    @ResponseBody
...
//            messageOut = send2160Handler.dispatch(FEPChannel.Send2160, messageIn);
            logData.setProgramName(StringUtils.join(ProgramName, ".processRequestData"));
