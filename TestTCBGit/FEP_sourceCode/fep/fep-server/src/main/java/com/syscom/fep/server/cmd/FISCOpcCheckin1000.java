...
public class FISCOpcCheckin1000 extends Command {

    public static void main(String[] args) {
        new FISCOpcCheckin1000().execute(args);
    }
    ...
    protected void displayUsage() {
        ...
        System.out.println(" FISCOpcCheckin1000 Options");
        System.out.println();
        ...
        System.out.println(" FISCCmdOpcCheckin1000 /Host:127.0.0.1 /Port:8101 /KeyId:04");
    }
    ...
    protected void process(String[] args) throws Exception {
        ...
        String result = this.httpPost("http://" + host + ":" + port + "/opc/checkin1000", new String[] {"keyId=" + keyId, "operator=" + operator});
