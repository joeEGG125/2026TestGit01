...
public class FISCOpcNotice extends Command {

    public static void main(String[] args) {
        new FISCOpcNotice().execute(args);
    }
    ...
    protected void displayUsage() {
        ...
        System.out.println(" FISCOpcNotice Options");
        System.out.println();
        ...
        System.out.println(" FISCCmdOpcNotice /Host:127.0.0.1 /Port:8101 /KeyId:04");
    }
    ...
    protected void process(String[] args) throws Exception {
        ...
        String result = this.httpPost("http://" + host + ":" + port + "/opc/notice", new String[] {"keyId=" + keyId, "operator=" + operator});
