...
@ConfigurationProperties(prefix = "spring.fep.server.fisc")
public class FISCConfiguration {
    // 執行緒線程池固定大小
    ...
    public void postConstruct() {
        LogHelperFactory.getGeneralLogger().info(ConfigurationPropertiesUtil.info(this, "FISC Service Configuration"));
    }
}
