...
public class UI_012280_FormDetail extends BaseForm {
    private String tradingDate;
    private String bkno;
    private String stan;
    private String queryflagtxt;

    public UI_012280_FormDetail() {
        super();
    }

    public UI_012280_FormDetail(String tradingDate,String bkno,String stan,String queryflagtxt) {
