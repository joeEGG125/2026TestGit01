 ...
 * @author Richard
 */
public interface MBQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#MB}
     */
    String INSTANCE_NAME = "mb";
    ...
    default void printConstant() {
        Field[] fields = MBQueueConstant.class.getDeclaredFields();
