 ...
 * @author Richard
 */
public interface PyBatchQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#PYBATCH}
     */
    String INSTANCE_NAME = "pybatch";
    ...
    String CONFIGURATION_PROPERTIES_PREFIX_OPTION = CONFIGURATION_PROPERTIES_PREFIX + ".option";

    default void printConstant() {
        Field[] fields = PyBatchQueueConstant.class.getDeclaredFields();
