 ...
 * @author Richard
 */
public interface VIPQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#VIP}
     */
    String INSTANCE_NAME = "vip";
    ...
    default void printConstant() {
        Field[] fields = VIPQueueConstant.class.getDeclaredFields();
