 ...
 * @author Richard
 */
public interface FISCQueueSenderConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#FISC}
     */
    public static final String INSTANCE_NAME = "fisc.sender";
    ...
    default void printConstant() {
        Field[] fields = FISCQueueSenderConstant.class.getDeclaredFields();
