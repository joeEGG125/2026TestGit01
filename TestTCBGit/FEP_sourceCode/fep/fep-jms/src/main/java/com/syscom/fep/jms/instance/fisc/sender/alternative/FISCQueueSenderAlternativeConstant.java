 ...
 * @author Richard
 */
public interface FISCQueueSenderAlternativeConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#FISC}
     */
    public static final String INSTANCE_NAME = "fisc.sender.alternative";
    ...
    default void printConstant() {
        Field[] fields = FISCQueueSenderAlternativeConstant.class.getDeclaredFields();
