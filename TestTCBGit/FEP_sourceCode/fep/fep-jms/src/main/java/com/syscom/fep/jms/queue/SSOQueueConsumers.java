...
public class SSOQueueConsumers extends JmsNotifier<String, JmsReceiver<String>> implements JmsMsgConstant {
    ...
    @Override
    @JmsListener(
            id = "#{@" + QUEUE_NAME_SSO + CONFIGURATION_PROPERTIES_SUFFIX_IDENTITY + "}",
            destination = "#{@" + QUEUE_NAME_SSO + CONFIGURATION_PROPERTIES_SUFFIX_DESTINATION + "}",
            concurrency = "#{@" + QUEUE_NAME_SSO + CONFIGURATION_PROPERTIES_SUFFIX_CONCURRENCY + "}",
