 ...
 * @author Richard
 */
public interface FISCQueueReceiverAlternativeConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#FISC}
     */
    public static final String INSTANCE_NAME = "fisc.receiver.alternative";
    ...
    public static final String QUEUE_INSTANCE_NAME = "jmsMsgConfiguration.queueNames.fisc";

    default void printConstant() {
        Field[] fields = FISCQueueReceiverAlternativeConstant.class.getDeclaredFields();
