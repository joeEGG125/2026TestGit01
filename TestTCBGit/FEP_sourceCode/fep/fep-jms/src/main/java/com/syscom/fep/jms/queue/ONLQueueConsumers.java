...
public class ONLQueueConsumers extends JmsNotifier<String, JmsReceiver<String>> implements JmsMsgConstant {
    ...
    @Override
    @JmsListener(
            id = "#{@" + QUEUE_NAME_ONL + CONFIGURATION_PROPERTIES_SUFFIX_IDENTITY + "}",
            destination = "#{@" + QUEUE_NAME_ONL + CONFIGURATION_PROPERTIES_SUFFIX_DESTINATION + "}",
            concurrency = "#{@" + QUEUE_NAME_ONL + CONFIGURATION_PROPERTIES_SUFFIX_CONCURRENCY + "}",
