 ...
 * @author Richard
 */
public interface DIGITALQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#DIGITAL}
     */
    String INSTANCE_NAME = "digital";
    ...
    default void printConstant() {
        Field[] fields = DIGITALQueueConstant.class.getDeclaredFields();
