 ...
 * @author Richard
 */
public interface EOIQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#EOI}
     */
    String INSTANCE_NAME = "eoi";
    ...
    default void printConstant() {
        Field[] fields = EOIQueueConstant.class.getDeclaredFields();
