 ...
 * @author Richard
 */
public interface NBQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#NB}
     */
    String INSTANCE_NAME = "nb";
    ...
    default void printConstant() {
        Field[] fields = NBQueueConstant.class.getDeclaredFields();
