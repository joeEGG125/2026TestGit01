 ...
 * @author Richard
 */
public interface BIZLOANQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#BIZLOAN}
     */
    String INSTANCE_NAME = "bizloan";
    ...
    default void printConstant() {
        Field[] fields = BIZLOANQueueConstant.class.getDeclaredFields();
