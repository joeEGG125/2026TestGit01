 ...
 * @author Richard
 */
public interface MCHQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#MCH}
     */
    String INSTANCE_NAME = "mch";
    ...
    default void printConstant() {
        Field[] fields = MCHQueueConstant.class.getDeclaredFields();
