 ...
 * @author Richard
 */
public interface ONLQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#ONL}
     */
    String INSTANCE_NAME = "onl";
    ...
    default void printConstant() {
        Field[] fields = ONLQueueConstant.class.getDeclaredFields();
