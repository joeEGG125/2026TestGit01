 ...
 * @author Richard
 */
public interface BatchQueueHostConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#BATCH}
     */
    public static final String INSTANCE_NAME = "batch.hosts";
    ...
    public static final String CONFIGURATION_PROPERTIES_HOST_NAME = CONFIGURATION_PROPERTIES_PREFIX_PROP + ".host-name";
    ...
    public static final String JMS_PROPERTIES_MAP = INSTANCE_NAME + "JmsPropertiesMap";
    public static final String JMS_OPERATOR_MAP = INSTANCE_NAME + "JmsOperatorMap";

    default void printConstant() {
        Field[] fields = BatchQueueHostConstant.class.getDeclaredFields();
