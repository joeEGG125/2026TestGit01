 ...
 * @author Richard
 */
public interface NONVIPQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#NONVIP}
     */
    String INSTANCE_NAME = "nonvip";
    ...
    default void printConstant() {
        Field[] fields = NONVIPQueueConstant.class.getDeclaredFields();
