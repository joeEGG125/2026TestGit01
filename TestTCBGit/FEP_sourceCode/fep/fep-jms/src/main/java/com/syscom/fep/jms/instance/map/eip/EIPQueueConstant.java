 ...
 * @author Richard
 */
public interface EIPQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#EIP}
     */
    String INSTANCE_NAME = "eip";
    ...
    default void printConstant() {
        Field[] fields = EIPQueueConstant.class.getDeclaredFields();
