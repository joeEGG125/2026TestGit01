 ...
 * @author Richard
 */
public interface MFTQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#MFT}
     */
    String INSTANCE_NAME = "mft";
    ...
    default void printConstant() {
        Field[] fields = MFTQueueConstant.class.getDeclaredFields();
