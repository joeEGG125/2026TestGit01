 ...
 * @author Richard
 */
public interface SSOQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#SSO}
     */
    String INSTANCE_NAME = "sso";
    ...
    default void printConstant() {
        Field[] fields = SSOQueueConstant.class.getDeclaredFields();
