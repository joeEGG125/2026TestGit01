 ...
 * @author Richard
 */
public interface FIDOQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#FIDO}
     */
    String INSTANCE_NAME = "fido";
    ...
    default void printConstant() {
        Field[] fields = FIDOQueueConstant.class.getDeclaredFields();
