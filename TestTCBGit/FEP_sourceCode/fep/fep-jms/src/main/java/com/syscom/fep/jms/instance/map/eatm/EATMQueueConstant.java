 ...
 * @author Richard
 */
public interface EATMQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#EATM}
     */
    String INSTANCE_NAME = "eatm";
    ...
    default void printConstant() {
        Field[] fields = EATMQueueConstant.class.getDeclaredFields();
