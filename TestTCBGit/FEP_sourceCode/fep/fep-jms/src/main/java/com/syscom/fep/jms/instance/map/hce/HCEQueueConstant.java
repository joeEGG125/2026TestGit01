 ...
 * @author Richard
 */
public interface HCEQueueConstant {
    /**
     * Instance Name with lower case, please refer {@link JmsMsgInstanceName#HCE}
     */
    String INSTANCE_NAME = "hce";
    ...
    default void printConstant() {
        Field[] fields = HCEQueueConstant.class.getDeclaredFields();
