...
//	private SmsmsgExtMapper smsmsgExtMapper = SpringBeanFactoryUtil.getBean(SmsmsgExtMapper.class);
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		...
		/* 2025/10/7 修改 */
		if (StringUtils.isNotBlank(obtltxn.getObtltxnOriStan())){
			cbsTita.setBIT36_TMSTAN1( obtltxn.getObtltxnBkno() + obtltxn.getObtltxnOriStan()); // 原交易序號
		}
		cbsTita.setBIT36_OENTAFEE(obtltxn.getObtltxnTotTwdFee()); // 台幣總手續費
		cbsTita.setBIT36_OGTXAMT(obtltxn.getObtltxnTotForAmt()); // 外幣總金額s
