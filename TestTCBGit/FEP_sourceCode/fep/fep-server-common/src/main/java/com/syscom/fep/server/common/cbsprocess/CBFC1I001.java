...
public class CBFC1I001 extends ACBSAction {
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		...
		cbstita.setPIEPIN(feptxn.getFeptxnPinblock() + StringUtils.repeat("40",8)); // 密碼
		cbstita.setPIPTRIES(atmReq.getPIPTRIES()); // 密碼TRY次數
		//TRK3
		cbstita.setTRK3(atmReq.getCARDPART1() + atmReq.getPART1() +
						atmReq.getCARDPART2() + atmReq.getPART2() +
						atmReq.getCARDPART3() + atmReq.getPART3() +
						atmReq.getPART4() + atmReq.getPARTV() +
						atmReq.getPART5());
