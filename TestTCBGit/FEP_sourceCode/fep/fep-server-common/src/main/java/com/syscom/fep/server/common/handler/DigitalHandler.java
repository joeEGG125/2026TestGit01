...
public class DigitalHandler extends HandlerBase {
    ...
    private String getResStr(FEPReturnCode code, String MSGID, RCV_VA_GeneralTrans_RQ.RCV_VA_GeneralTrans_RQ_Body_MsgRq_Header vaReqheader) {
        String ResStr = "";
