...
import com.syscom.fep.vo.text.ims.CB_P1T_I002;
import com.syscom.fep.vo.text.ims.CB_P1T_O002;
...
public class CBP1TI002 extends ACBSAction {

	public CBP1TI002(MessageBase txData) {
		super(txData, new CB_P1T_O002());
	}
	...
	public FEPReturnCode getCbsTita(String txType) throws Exception {
		/* TITA 請參考合庫主機電文規格(CB_P1T_I002) */
		// Header
		CB_P1T_I002 cbstita = new CB_P1T_I002();
		...
		cbstita.setATM_STATUSCODE(atmReq.getSTATUS().substring(0, 2)); //交易STATUS
	...
	public FEPReturnCode processCbsTota(String cbsTota, String type) throws Exception {
		/* 電文內容格式請參照TOTA電文格式(CB_P1T_O002) */
		/* 拆解主機回應電文 */
		CB_P1T_O002 tota = new CB_P1T_O002();
	 ...
	 * @throws Exception
	 */
	private FEPReturnCode updateFEPTxn(CB_P1T_O002 cbsTota) throws Exception {
