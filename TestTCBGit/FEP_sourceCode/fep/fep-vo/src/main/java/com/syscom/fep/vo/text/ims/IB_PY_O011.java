...
public class IB_PY_O011 extends IMSTextBase {
    ...
    @Field(length = 2)
	private String PY_HOST_CHARGE = StringUtils.EMPTY;

    @Field(length = 1)
	private String PY_CHARGE_FLAG = StringUtils.EMPTY;

    @Field(length = 13)
	private String HBKNO_TOACT = StringUtils.EMPTY;

    @Field(length = 2)
	private String TR_TYPE = StringUtils.EMPTY;
	...
	public String getPY_HOST_CHARGE(){
        return this.PY_HOST_CHARGE;
	}
	
	public void setPY_HOST_CHARGE(String PY_HOST_CHARGE){
        this.PY_HOST_CHARGE = PY_HOST_CHARGE;
	}
	
	public String getPY_CHARGE_FLAG(){
        return this.PY_CHARGE_FLAG;
	}
	
	public void setPY_CHARGE_FLAG(String PY_CHARGE_FLAG){
        this.PY_CHARGE_FLAG = PY_CHARGE_FLAG;
	}
	
	public String getHBKNO_TOACT(){
        return this.HBKNO_TOACT;
	}
	
	public void setHBKNO_TOACT(String HBKNO_TOACT){
        this.HBKNO_TOACT = HBKNO_TOACT;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPY_HOST_CHARGE(EbcdicConverter.fromHex(CCSID.English,tita.substring(562, 566)));
        this.setPY_CHARGE_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(566, 568)));
        this.setHBKNO_TOACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(568, 594)));
        this.setTR_TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(594, 598)));
        this.setSA_ACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(598, 630)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(630, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPY_HOST_CHARGE(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPY_CHARGE_FLAG(), 1) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getHBKNO_TOACT(), 13) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTR_TYPE(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getSA_ACT(), 16) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 285) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPY_HOST_CHARGE(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPY_CHARGE_FLAG(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getHBKNO_TOACT(), StringUtils.EMPTY), 13," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTR_TYPE(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getSA_ACT(), StringUtils.EMPTY), 16," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 285," ")
		;
	}
}
