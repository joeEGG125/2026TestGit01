...
public class B01_Request extends CreditTextBase {
    ...
    //
    @Field(length = 515, optional = true)
    ...
    public String makeMessageFromGeneral(CreditGeneral general) throws Exception {
        ...
        _VALIDDT = StringUtils.rightPad(tempVar.getVALIDDT(),4,' '); //卡片效期
        ...
        return _NUMBER + _CARD_NO + _ACCOUNT + _CD1 + _CD2 + _CD3 + _TXDATE + _KINBR + _WSNO + _TXSEQ + _TBSDY + _MODE + _TXCD + _RC + _ASPSTAN + _CARDNO + _ACTNO + _SEQNO + _VALIDDT + _BIRTHDAY + _ACTION + _ASPSTOP + _FILLER1;
