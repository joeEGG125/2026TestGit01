...
public class ATM_FAA_FIDO_CC1B1PN extends ATMTextBase {
	@Field(length = 5)
	...
	@Field(length = 19)
	private String EXPIREDATE = StringUtils.EMPTY;
	
	@Field(length = 500)
	private String QRCODE = StringUtils.EMPTY;
	
	private static final int _TotalLength = 753;
	...
	public String makeMessage() {
		...
		this.setEXPIREDATE(StringUtils.rightPad(this.getEXPIREDATE(),19,StringUtils.SPACE));
		this.setQRCODE(StringUtils.rightPad(this.getQRCODE(),500,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getEXPIREDATE(),19) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getQRCODE(),500)
		      ;
	}
