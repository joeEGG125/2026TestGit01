...
public class IB_UHT1_I001 extends IMSTextBase {
    @Field(length = 8)
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setUH_special_flag(EbcdicConverter.fromHex(CCSID.English,tita.substring(500, 504)));
        this.setTAX_TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(504, 514)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(514, 1200)));
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 343) //
;
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.leftPad(this.getDRVS(), 343," ") //
;
}
}
