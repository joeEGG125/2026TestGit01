...
public class AB_TR_I001 extends IMSTextBase {
    ...
    @Field(length = 2)
	private String TO_ACT_TYPE = StringUtils.EMPTY;
	...
	public String getTO_ACT_TYPE(){
        return this.TO_ACT_TYPE;
	}
	
	public void setTO_ACT_TYPE(String TO_ACT_TYPE){
        this.TO_ACT_TYPE = TO_ACT_TYPE;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
		...
		this.setTXMEMO(tita.substring(504, 584));
		...
		this.setTO_ACT_MEMO(tita.substring(642, 674));
		this.setFROM_ACT_MEMO(tita.substring(674, 706));
        this.setTO_ACT_TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(706, 710)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(710, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
        	...
        	+ this.getTO_ACT_MEMO()  
        	+ this.getFROM_ACT_MEMO()  
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTO_ACT_TYPE(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 245) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
        	...
        	+ this.getTO_ACT_MEMO()  
        	+ this.getFROM_ACT_MEMO()  
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTO_ACT_TYPE(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 245," ")
		;
	}
}
