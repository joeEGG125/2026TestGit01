...
public class ATM_FCA_FRA extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 490;
	...
	public String makeMessage() {
		...
		this.setACTDATA(StringUtils.rightPad(this.getACTDATA(),452,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getACTDATA(),452) +
