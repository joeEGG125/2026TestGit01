...
public class CB_I5_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 13)
	private String D9CNO = StringUtils.EMPTY;
	...
	public String getD9CNO(){
        return this.D9CNO;
	}

	public void setD9CNO(String D9CNO){
        this.D9CNO = D9CNO;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setSPECIAL_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(500, 504)));
        ...
        this.setD9CNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(608, 634)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(634, 1200)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getD9CNO(), 13) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 283) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getD9CNO(), StringUtils.EMPTY), 13," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 283," ") //
		;
	}
}
