...
public class IB_WW_I001 extends IMSTextBase {
    ...
    @Field(length = 4)
	private String BIT36_POSENTRYMODE = StringUtils.EMPTY;

    @Field(length = 8)
	private String ARQC = StringUtils.EMPTY;
	...
	public String getBIT36_POSENTRYMODE(){
        return this.BIT36_POSENTRYMODE;
	}
	
	public void setBIT36_POSENTRYMODE(String BIT36_POSENTRYMODE){
        this.BIT36_POSENTRYMODE = BIT36_POSENTRYMODE;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setBIT36_POSENTRYMODE(EbcdicConverter.fromHex(CCSID.English,tita.substring(788, 796)));
        this.setARQC(EbcdicConverter.fromHex(CCSID.English,tita.substring(796, 812)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(812, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getBIT36_POSENTRYMODE(), 4) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getARQC(), 8) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 194) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getBIT36_CURRN(), StringUtils.EMPTY), 12," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getBIT36_POSENTRYMODE(), StringUtils.EMPTY), 4," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getARQC(), StringUtils.EMPTY), 8," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 194," ")
		;
	}
}
