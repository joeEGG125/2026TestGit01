...
public class EWVRequest extends ATMTextBase {
	//空白
	@Field(length = 4)
	private String _TA = "";
	...
	//
	@Field(length = 390, optional = true)
	...
	public void set_DSPCNT3T(String _DSPCNT3T) {
	...
	public void setICEMV(String _ICEMV) {
		this._ICEMV = _ICEMV;
	}
	...
	public void setACFEE(String _ACFEE) {
		this._ACFEE = _ACFEE;
	}
	...
	public void toGeneral(ATMGeneral atmGeneral) throws Exception {
		...
		atmGeneral.getRequest().setAID(this.toAscii(_AID)); // Application ID
		atmGeneral.getRequest().setFILLER2(this.toAscii(_FILLER2)); //FILLER2
		atmGeneral.getRequest().setTXAMT(this.toBigDecimal(this.getTXAMT()));// 交易金額
		atmGeneral.getRequest().setDSPCNT1(this.toBigDecimal(this.getDSPCNT1()));// 吐鈔張數 1 (個拾位)
		atmGeneral.getRequest().setDSPCNT2(this.toBigDecimal(this.getDSPCNT2()));// 吐鈔張數 2 (個拾位)
		atmGeneral.getRequest().setDSPCNT3(this.toBigDecimal(this.getDSPCNT3())); // 吐鈔張數 3(個拾位)
		atmGeneral.getRequest().setDSPCNT4(this.toBigDecimal(this.getDSPCNT4())); // 吐鈔張數 4 (個拾位)
		atmGeneral.getRequest().setYYMMDD(this.toAscii(_YYMMDD)); //壓碼日期
		atmGeneral.getRequest().setMAC(this.toAscii(_MAC)); //訊息押碼
		atmGeneral.getRequest().setDSPCNT1T(this.toBigDecimal(this.getDSPCNT1T()));// 吐鈔張數 1 (千百位)
		atmGeneral.getRequest().setDSPCNT2T(this.toBigDecimal(this.getDSPCNT2T()));// 吐鈔張數 2 (千百位)
		atmGeneral.getRequest().setDSPCNT3T(this.toBigDecimal(this.getDSPCNT3T())); // 吐鈔張數 3(千百位)
		atmGeneral.getRequest().setDSPCNT4T(this.toBigDecimal(this.getDSPCNT4T())); // 吐鈔張數 4 (千百位)
		atmGeneral.getRequest().setDSPCNT5(this.toBigDecimal(this.getDSPCNT5()));// 吐鈔張數 5 (千百個拾)
		atmGeneral.getRequest().setDSPCNT6(this.toBigDecimal(this.getDSPCNT6()));// 吐鈔張數 6 (千百個拾)
		atmGeneral.getRequest().setDSPCNT7(this.toBigDecimal(this.getDSPCNT7())); // 吐鈔張數 7(千百個拾)
		atmGeneral.getRequest().setDSPCNT8(this.toBigDecimal(this.getDSPCNT8())); // 吐鈔張數 8 (千百個拾)
		atmGeneral.getRequest().setICEMV(this.toAscii(_ICEMV)); // 該卡是否通過初步檢核
		atmGeneral.getRequest().setPOSENTRYMOD(this.toAscii(_POSENTRYMOD)); // POS ENTRY MODE
		atmGeneral.getRequest().setACFEE(this.toAscii(_ACFEE));// 客戶是否同意收Access Fee
