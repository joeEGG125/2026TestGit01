...
public class B03_Request extends CreditTextBase {
    //交易序號
    @Field(length = 6)
    ...
    private String _OLDPINB = "";

    //新 PIN BLOCK
    @Field(length = 16, optional = true)
    private String _NEWPINB = "";
    ...
    //
    @Field(length = 382, optional = true)
    ...
    /**
     ...
     <remark>1.      國際卡密碼檢核時，同TRK1欄位放置之PIN BLOCK。       2.      更改預借現金密碼時，此欄位為舊PIN BLOCK。</remark>
     */
    public String getOLDPINB() {
        return _OLDPINB;
    }
    public void setOLDPINB(String value) {
        _OLDPINB = value;
    }
    ...
    /**
     ...
     <remark>1.      國際卡密碼檢核時，同TRK1欄位放置之PIN BLOCK。       2.      更改預借現金密碼時，此欄位為新PIN BLOCK。</remark>
     */
    public String getNEWPINB() {
        return _NEWPINB;
    }
    public void setNEWPINB(String value) {
        _NEWPINB = value;
    }
    ...
    public String makeMessageFromGeneral(CreditGeneral general) throws Exception {
        ...
        _TRACK2 = StringUtils.rightPad(tempVar.getTRACK2(),37,' '); //磁條二軌資料
        _TRACK1 = StringUtils.rightPad(tempVar.getTRACK1(),76,' '); //磁條一軌資料
        _OLDPINB = StringUtils.rightPad(tempVar.getOLDPINB(),16,' '); //舊PIN BLOCK
        _NEWPINB = StringUtils.rightPad(tempVar.getNEWPINB(),16,' '); //新 PIN BLOCK
        ...
        return _NUMBER + _CARD_NO + _ACCOUNT + _CD1 + _CD2 + _CD3 + _TXDATE + _KINBR + _WSNO + _TXSEQ + _TBSDY + _MODE + _TXCD + _RC + _ASPSTAN + _CARDNO + _ACTNO + _SEQNO + _TRACK2 + _TRACK1 + _OLDPINB + _NEWPINB + _ACTION + _TripleDES + _FILLER1;
