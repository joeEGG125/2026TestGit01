...
public class IB_WD_TR_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 10)
        private String J2_ORG_STAN = StringUtils.EMPTY;

    @Field(length = 2)
        private String J2_Reason_Code = StringUtils.EMPTY;
    ...
    @Field(length = 341)
        ...
        public String getJ2_ORG_STAN(){
        return this.J2_ORG_STAN;
        }
        public void setJ2_ORG_STAN(String J2_ORG_STAN){
        this.J2_ORG_STAN = J2_ORG_STAN;
        }
        public String getJ2_Reason_Code(){
        return this.J2_Reason_Code;
        }
        public void setJ2_Reason_Code(String J2_Reason_Code){
        this.J2_Reason_Code = J2_Reason_Code;
        }
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setJ2_ORG_STAN(EbcdicConverter.fromHex(CCSID.English,tita.substring(440, 460)));
        this.setJ2_Reason_Code(EbcdicConverter.fromHex(CCSID.English,tita.substring(460, 464)));
        this.setBIT35_JRNATION(EbcdicConverter.fromHex(CCSID.English,tita.substring(464, 470)));
        this.setBIT35_JRCCD(EbcdicConverter.fromHex(CCSID.English,tita.substring(470, 476)));
        this.setBIT35_JTAIFEE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(476, 490).trim()), false, 0));
        this.setBIT35_WAMTDISP(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(490, 518).trim()), false, 2));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(518, 1200)));
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getJ2_ORG_STAN(), 10) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getJ2_Reason_Code(), 2) //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 341) //
;
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.leftPad(this.getJ2_ORG_STAN(), 10," ") //
            + StringUtils.leftPad(this.getJ2_Reason_Code(), 2," ") //
            ...
            + StringUtils.leftPad(this.getDRVS(), 341," ") //
;
}
}
