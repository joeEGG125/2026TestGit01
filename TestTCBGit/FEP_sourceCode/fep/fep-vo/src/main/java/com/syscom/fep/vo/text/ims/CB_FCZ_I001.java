...
public class CB_FCZ_I001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setTXNICCTAC(EbcdicConverter.fromHex(CCSID.English,tita.substring(360, 400)));
        this.setTXNAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(400, 428).trim()), false, 2));
        this.setFROMACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(428, 460)));
        this.setTOACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(460, 492)));
        this.setSPECIAL_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(492, 496)));
        this.setCUSTID(EbcdicConverter.fromHex(CCSID.English,tita.substring(496, 516)));
        this.setBIRDAY(EbcdicConverter.fromHex(CCSID.English,tita.substring(516, 532)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(532, 1220)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 344) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 344," ") //
		;
	}
}
