...
public class AB_LF_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 1)
	private String MNOCHANGE = StringUtils.EMPTY;
	...
	public String getMNOCHANGE(){
        return this.MNOCHANGE;
	}
	
	public void setMNOCHANGE(String MNOCHANGE){
        this.MNOCHANGE = MNOCHANGE;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setAEILFRC1(EbcdicConverter.fromHex(CCSID.English,tita.substring(558, 562)));
        this.setAEILFRC2(EbcdicConverter.fromHex(CCSID.English,tita.substring(562, 566)));
        this.setOPENACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(566, 570)));
        this.setMNOCHANGE(EbcdicConverter.fromHex(CCSID.English,tita.substring(570, 572)));
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getMNOCHANGE(), 1) 
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAEIPYTP(), StringUtils.EMPTY), 1," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTAXIDNO(), StringUtils.EMPTY), 10," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAEIPYUSE(), StringUtils.EMPTY), 2," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getMNOCHANGE(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 314," ")
		;
	}
}
