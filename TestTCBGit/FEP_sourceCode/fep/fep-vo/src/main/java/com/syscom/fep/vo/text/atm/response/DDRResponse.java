...
public class DDRResponse extends ATMTextBase {
	// 交易類別
	@Field(length = 6)
	...
	private String _BAL11_S = StringUtils.EMPTY;

	// 可用餘額
	@Field(length = 26, optional = true)
	private String _BAL11 = StringUtils.EMPTY;

	// 正負號
	@Field(length = 2, optional = true)
	private String _BAL12_S = StringUtils.EMPTY;

	// 帳戶餘額
	@Field(length = 26, optional = true)
	private String _BAL12 = StringUtils.EMPTY;

	// 正負號
	@Field(length = 2, optional = true)
	private String _BAL13_S = StringUtils.EMPTY;

	// 累計提款額
	@Field(length = 26, optional = true)
	private String _BAL13 = StringUtils.EMPTY;

	// 正負號
	@Field(length = 2, optional = true)
	private String _BAL14_S = StringUtils.EMPTY;

	// BAL14
	@Field(length = 26, optional = true)
	private String _BAL14 = StringUtils.EMPTY;

	// 需寫第三軌記號
	@Field(length = 2, optional = true)
	private String _WTRK3 = StringUtils.EMPTY;

	// 第三軌資料
	@Field(length = 208, optional = true)
	private String _TRACK3 = StringUtils.EMPTY;

	// 吃卡記號
	@Field(length = 2, optional = true)
	private String _RSCARD = StringUtils.EMPTY;
	...
	//
	@Field(length = 558, optional = true)
	...
	public String makeMessageFromGeneral(ATMGeneral general) throws Exception {
		...
		this._BAL11_S = StringUtil.toHex(StringUtils.rightPad(response.getBal11S(), 1, StringUtils.SPACE)); // 正負號
		this._BAL11 = this.toHex(response.getBAL11(), 13, 2); // 可用餘額
		this._BAL12_S = StringUtil.toHex(StringUtils.rightPad(response.getBal12S(), 1, StringUtils.SPACE)); // 正負號
		this._BAL12 = this.toHex(response.getBAL12(), 13, 2); // 帳戶餘額
		this._BAL13_S = StringUtil.toHex(StringUtils.rightPad(response.getBal13S(), 1, StringUtils.SPACE)); // 正負號
		this._BAL13 = this.toHex(response.getBAL13(), 13, 2); // 累計提款額
		this._BAL14_S = StringUtil.toHex(StringUtils.rightPad(response.getBal14S(), 1, StringUtils.SPACE)); // 正負號
		this._BAL14 = this.toHex(response.getBAL14(), 13, 2); // BAL14
		this._WTRK3 = StringUtil.toHex(StringUtils.rightPad(response.getWTRK3(), 1, StringUtils.SPACE)); // 需寫第三軌記號
		this._TRACK3 = StringUtil.toHex(StringUtils.rightPad(response.getTRACK3(), 104, StringUtils.SPACE)); // 第三軌資料
		this._RSCARD = StringUtil.toHex(StringUtils.rightPad(response.getRSCARD(), 1, StringUtils.SPACE)); // 吃卡記號
		...
		this._FILLER1 = StringUtil.toHex(StringUtils.leftPad(StringUtils.EMPTY, 279, StringUtils.SPACE));
		...
		return StringUtils.join(this._TXCD_O, this._DATE, this._TIME, this._ATMNO_O, this._MODE_O, this._DD_O, this._DEPMODE_O, this._ATMSEQ_O1, this._ATMSEQ_O2, this._REJCD, this._TXSEQ, this._HC,
				this._NBCNT, this._CDWAMT, this._BKNO, this._CHACT, this._TXACT, this._TXAMT, this._BAL11_S, this._BAL11, this._BAL12_S, this._BAL12, this._BAL13_S, this._BAL13, this._BAL14_S,
				this._BAL14, this._WTRK3, this._TRACK3, this._RSCARD, this._YYMMDD, this._MAC, this._STAN, this._VPSWD, this._PID, this._CURCD, this._UNIT01, this._DSPCNT01, this._UNIT02,
				this._DSPCNT02, this._UNIT03, this._DSPCNT03, this._UNIT04, this._DSPCNT04, this._UNIT05, this._DSPCNT05, this._UNIT06, this._DSPCNT06, this._UNIT07, this._DSPCNT07, this._UNIT08,
				this._DSPCNT08, this._UNIT09, this._DSPCNT09, this._UNIT10, this._DSPCNT10, this._UNIT11, this._DSPCNT11, this._UNIT12, this._DSPCNT12, this._UNIT13, this._DSPCNT13, this._UNIT14,
				this._DSPCNT14, this._UNIT15, this._DSPCNT15, this._UNIT16, this._DSPCNT16, this._UNIT17, this._DSPCNT17, this._UNIT18, this._DSPCNT18, this._UNIT19, this._DSPCNT19, this._UNIT20,
				this._DSPCNT20, this._FILLER1);
		*/return "";
    }
