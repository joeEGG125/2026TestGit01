...
public class B15_Request extends CreditTextBase {
    //交易序號
    @Field(length = 6)
    ...
    public String makeMessageFromGeneral(CreditGeneral general) throws Exception {
        ...
        return _NUMBER + _CARD_NO + _ACCOUNT + _CD1 + _CD2 + _CD3 + _TXDATE + _KINBR + _WSNO + _TXSEQ + _TBSDY + _MODE + _TXCD + _RC + _ASPSTAN + _CARDNO + _ACTNO + _SEQNO + _TRACK2 + _FPB + _MAC + _TripleDES + _FILLER1;
    }
