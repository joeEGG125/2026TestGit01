...
public class CB_TXEND extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(240, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 480) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 480," ") //
		;
	}
}
