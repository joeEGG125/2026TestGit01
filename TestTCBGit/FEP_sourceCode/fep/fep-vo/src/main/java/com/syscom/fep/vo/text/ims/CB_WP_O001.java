...
public class CB_WP_O001 extends IMSTextBase {
    ...
    @Field(length = 37)
	private String T2DATA = StringUtils.EMPTY;
	...
	public void setT2DATA(String T2DATA){
        this.T2DATA = T2DATA;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPRCRDACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 528)));
        this.setT2DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(528, 602)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(602, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getT2DATA(), 37) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 299) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getT2DATA(), StringUtils.EMPTY), 37," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 299," ")
		;
	}
}
