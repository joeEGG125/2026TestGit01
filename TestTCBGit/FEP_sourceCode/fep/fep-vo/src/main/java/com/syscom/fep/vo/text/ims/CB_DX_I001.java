...
public class CB_DX_I001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPITELNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(476, 556)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(556, 1200)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPITELNO(), 40) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 322) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPITELNO(), StringUtils.EMPTY), 40," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 322," ") //
		;
	}
}
