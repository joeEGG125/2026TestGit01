...
public class CB_P1T_I002 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 1)
	private String PICRDSTS = StringUtils.EMPTY;

    @Field(length = 2)
	private String ATM_STATUSCODE = StringUtils.EMPTY;

    @Field(length = 104)
	private String TRK3DATA = StringUtils.EMPTY;
	...
	public String getPICRDSTS(){
        return this.PICRDSTS;
	}
	
	public void setPICRDSTS(String PICRDSTS){
        this.PICRDSTS = PICRDSTS;
	}
	
	public String getATM_STATUSCODE(){
        return this.ATM_STATUSCODE;
	}
	
	public void setATM_STATUSCODE(String ATM_STATUSCODE){
        this.ATM_STATUSCODE = ATM_STATUSCODE;
	}
	
	public String getTRK3DATA(){
        return this.TRK3DATA;
	}
	
	public void setTRK3DATA(String TRK3DATA){
        this.TRK3DATA = TRK3DATA;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
		...
		this.setPIEPIN(tita.substring(440, 472));
        this.setPIPTRIES(EbcdicConverter.fromHex(CCSID.English,tita.substring(472, 476)));
        this.setPICRDSTS(EbcdicConverter.fromHex(CCSID.English,tita.substring(476, 478)));
        this.setATM_STATUSCODE(EbcdicConverter.fromHex(CCSID.English,tita.substring(478, 482)));
        this.setTRK3DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(482, 690)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(690, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPICRDSTS(), 1) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getATM_STATUSCODE(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTRK3DATA(), 104) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 255) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPICRDSTS(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getATM_STATUSCODE(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTRK3DATA(), StringUtils.EMPTY), 104," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 255," ")
		;
	}
}
