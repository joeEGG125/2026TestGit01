...
public class AB_WW_I001 extends IMSTextBase {
	...
	@Field(length = 37)
	private String TRK2DATA = StringUtils.EMPTY;

	@Field(length = 12)
	private BigDecimal OGSLAMT;

	@Field(length = 3)
	private String CCDSETTLE = StringUtils.EMPTY;
	...
	public String getTRK2DATA(){
		return this.TRK2DATA;
	}

	public void setTRK2DATA(String TRK2DATA){
		this.TRK2DATA = TRK2DATA;
	}

	public BigDecimal getOGSLAMT(){
		return this.OGSLAMT;
	}

	public void setOGSLAMT(BigDecimal OGSLAMT){
		this.OGSLAMT = OGSLAMT;
	}

	public String getCCDSETTLE(){
		return this.CCDSETTLE;
	}

	public void setCCDSETTLE(String CCDSETTLE){
		this.CCDSETTLE = CCDSETTLE;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
		...
		this.setTRK2DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(500, 574)));
		this.setOGSLAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(574, 598)).trim(), false, 2));
		this.setCCDSETTLE(EbcdicConverter.fromHex(CCSID.English,tita.substring(598, 604)));
		this.setTRANSTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(604, 606)));
	...
	public String makeMessage() {
		return ""
				...
				+ CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTRK2DATA(), 37)
				+ CodeGenUtil.bigDecimalToEbcdic(this.getOGSLAMT(), 10, false, 2, false)
				+ CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCCDSETTLE(), 3)
				+ CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTRANSTYPE(), 1)
	...
	public String makeMessageAscii() {
		return ""
				...
				+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTRK2DATA(), StringUtils.EMPTY), 37," ")
				+ CodeGenUtil.bigDecimalToAsciiCBS(this.getOGSLAMT(), 10, false, 2, false)
				+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCCDSETTLE(), StringUtils.EMPTY), 3," ")
				+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTRANSTYPE(), StringUtils.EMPTY), 1," ")
