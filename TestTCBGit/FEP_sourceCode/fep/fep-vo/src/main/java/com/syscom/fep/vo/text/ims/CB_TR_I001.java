...
public class CB_TR_I001 extends IMSTextBase {
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAE_AEIFSTBH(), StringUtils.EMPTY), 4," ") //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAE_AEICIRCU_EDI(), StringUtils.EMPTY), 12," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 214," ") //
		;
	}
}
