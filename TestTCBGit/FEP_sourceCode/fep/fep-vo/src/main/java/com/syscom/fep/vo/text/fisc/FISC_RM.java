...
// 財金電文Header
public class FISC_RM extends FISCHeader {
	// 保留欄位 1
	//
	// bitmap 位置: 1
	...
	// N( 7 ) 7
	// bitmap 位置: 8
	private String mFISC_NO = StringUtils.EMPTY;
	...
	// L( 2 )＋DATA( 中文 )
	// bitmap 位置: 21
	private String mALIASNAME = StringUtils.EMPTY;
	...
	// L( 2 )＋DATA( 文數字 )
	// bitmap 位置: 25
	private String mENGLISH_MEMO = StringUtils.EMPTY;
	...
	// 保留欄位 27 => 2012/8/30, 待解筆數
	//
	// bitmap 位置: 27
	private String mRM_PENDING_CNT = StringUtils.EMPTY;

	// 保留欄位 28 => 2012/8/30, 待解金額
	//
	// bitmap 位置: 28
	private String mRM_PENDING_AMT = StringUtils.EMPTY;
	...
	// 保留欄位 53 => 2012/8/30, 原交易序號
	//
	// bitmap 位置: 53
	private String mORG_STAN = StringUtils.EMPTY;
	...
	// 保留欄位 57 => 2012/8/30, 交易日期時間
	//
	// bitmap 位置: 57
	private String mORG_TX_DATETIME = StringUtils.EMPTY;
	...
	public FISC_RM(String fiscFlatfile) {
		super(fiscFlatfile);
	}
	...
	public void setFiscNo(String value) {
		mFISC_NO = value;
		mIndexValue[7] = value;
	}
	 ...
	 * </remark>
	 */
	public String getEnglishMemo() {
		return mENGLISH_MEMO;
	}

	public void setEnglishMemo(String value) {
		mENGLISH_MEMO = value;
	 ...
	 * </remark>
	 */
	public String getRmPendingCnt() {
		return mRM_PENDING_CNT;
	}

	public void setRmPendingCnt(String value) {
		mRM_PENDING_CNT = value;
	 ...
	 * </remark>
	 */
	public String getRmPendingAmt() {
		return mRM_PENDING_AMT;
	}

	public void setRmPendingAmt(String value) {
		mRM_PENDING_AMT = value;
	...
	public void setOrgStan(String value) {
		mORG_STAN = value;
	 ...
	 * </remark>
	 */
	public String getOrgTxDatetime() {
		return mORG_TX_DATETIME;
	}

	public void setOrgTxDatetime(String value) {
		mORG_TX_DATETIME = value;
