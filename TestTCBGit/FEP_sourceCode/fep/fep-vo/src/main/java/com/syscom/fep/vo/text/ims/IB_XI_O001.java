...
public class IB_XI_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setHBKNO_TOACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 552)));
        this.setTR_TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(552, 556)));
        this.setSA_ACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(556, 588)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(588, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 306) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 306," ")
		;
	}
}
