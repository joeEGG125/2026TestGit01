...
public class ATM_FRC extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 72;
	...
	public String makeMessage() {
		...
		this.setDATA(StringUtils.rightPad(this.getDATA(),34,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDATA(),34) +
