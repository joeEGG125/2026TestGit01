...
public class ATM_FAA_CC1APN extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 263;
	...
	public String makeMessage() {
		...
		this.setBALANCE(StringUtils.rightPad(this.getBALANCE(),18,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getBALANCE(),18) +
