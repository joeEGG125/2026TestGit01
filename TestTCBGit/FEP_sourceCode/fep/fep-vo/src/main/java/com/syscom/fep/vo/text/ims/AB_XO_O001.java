...
public class AB_XO_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 30)
	private String TR_USE = StringUtils.EMPTY;
    ...
    @Field(length = 14)
	private String TRANSAMTOUT = StringUtils.EMPTY;

    @Field(length = 1)
	private String TRTOCIRCU = StringUtils.EMPTY;

    @Field(length = 4)
	private String FXML_CHAFEEAMT = StringUtils.EMPTY;
	...
	public String getTR_USE(){
        return this.TR_USE;
	}
	
	public void setTR_USE(String TR_USE){
        this.TR_USE = TR_USE;
	}
	...
	public String getTRANSAMTOUT(){
        return this.TRANSAMTOUT;
	}
	
	public void setTRANSAMTOUT(String TRANSAMTOUT){
	...
	public String getFXML_CHAFEEAMT(){
        return this.FXML_CHAFEEAMT;
	}
	
	public void setFXML_CHAFEEAMT(String FXML_CHAFEEAMT){
        this.FXML_CHAFEEAMT = FXML_CHAFEEAMT;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setTR_USE(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 586)));
        ...
        this.setTRANSAMTOUT(EbcdicConverter.fromHex(CCSID.English,tita.substring(602, 630)));
        this.setTRTOCIRCU(EbcdicConverter.fromHex(CCSID.English,tita.substring(630, 632)));
        this.setFXML_CHAFEEAMT(EbcdicConverter.fromHex(CCSID.English,tita.substring(632, 640)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(640, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTR_USE(), 30) 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTRANSAMTOUT(), 14) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTRTOCIRCU(), 1) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFXML_CHAFEEAMT(), 4) 
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTR_USE(), StringUtils.EMPTY), 30," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTRANSAMTOUT(), StringUtils.EMPTY), 14," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTRTOCIRCU(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFXML_CHAFEEAMT(), StringUtils.EMPTY), 4," ")
