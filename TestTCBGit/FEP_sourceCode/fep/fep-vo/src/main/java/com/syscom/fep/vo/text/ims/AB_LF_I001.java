...
public class AB_LF_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 4)
	private BigDecimal LE_CHARGCUS;

    @Field(length = 2)
	private String LE_2566TYPE = StringUtils.EMPTY;

    @Field(length = 2)
	private String LE_AEIPYTP = StringUtils.EMPTY;

    @Field(length = 2)
	private String LF_AEIPYUES = StringUtils.EMPTY;
    ...
    @Field(length = 2)
	private String LF_AEIOPENACT = StringUtils.EMPTY;
	...
	public BigDecimal getLE_CHARGCUS(){
        return this.LE_CHARGCUS;
	}
	
	public void setLE_CHARGCUS(BigDecimal LE_CHARGCUS){
        this.LE_CHARGCUS = LE_CHARGCUS;
	}
	
	public String getLE_2566TYPE(){
        return this.LE_2566TYPE;
	}
	
	public void setLE_2566TYPE(String LE_2566TYPE){
        this.LE_2566TYPE = LE_2566TYPE;
	}
	...
	public String getLF_AEIPYUES(){
        return this.LF_AEIPYUES;
	}
	
	public void setLF_AEIPYUES(String LF_AEIPYUES){
        this.LF_AEIPYUES = LF_AEIPYUES;
	}
	...
	public String getLF_AEIOPENACT(){
        return this.LF_AEIOPENACT;
	}
	
	public void setLF_AEIOPENACT(String LF_AEIOPENACT){
        this.LF_AEIOPENACT = LF_AEIOPENACT;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setLE_CHARGCUS(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(440, 448)).trim(), false, 0));
        this.setLE_2566TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(448, 452)));
        this.setLE_AEIPYTP(EbcdicConverter.fromHex(CCSID.English,tita.substring(452, 456)));
        this.setLF_AEIPYUES(EbcdicConverter.fromHex(CCSID.English,tita.substring(456, 460)));
        this.setLF_AELFTP(EbcdicConverter.fromHex(CCSID.English,tita.substring(460, 464)));
        this.setLF_AEILFRC1(EbcdicConverter.fromHex(CCSID.English,tita.substring(464, 468)));
        this.setLF_AEILFRC2(EbcdicConverter.fromHex(CCSID.English,tita.substring(468, 472)));
        this.setLF_AEIOPENACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(472, 476)));
        this.setLE_IDNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(476, 496)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(496, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.bigDecimalToEbcdic(this.getLE_CHARGCUS(), 4, false, 0, false) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getLE_2566TYPE(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getLE_AEIPYTP(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getLF_AEIPYUES(), 2) 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getLF_AEIOPENACT(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getLE_IDNO(), 10) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 352) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
            ...
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getLE_CHARGCUS(), 4, false, 0, false)
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLE_2566TYPE(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLE_AEIPYTP(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLF_AEIPYUES(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLF_AELFTP(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLF_AEILFRC1(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLF_AEILFRC2(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLF_AEIOPENACT(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getLE_IDNO(), StringUtils.EMPTY), 10," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 352," ")
		;
	}
}
