...
public class CB_FC1_I001 extends IMSTextBase {
    ...
    @Field(length = 104)
	private String TRK3 = StringUtils.EMPTY;
	...
	public void setTRK3(String TRK3){
        this.TRK3 = TRK3;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setTRK3(EbcdicConverter.fromHex(CCSID.English,tita.substring(476, 684)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(684, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTRK3(), 104) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 258) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTRK3(), StringUtils.EMPTY), 104," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 258," ")
		;
	}
}
