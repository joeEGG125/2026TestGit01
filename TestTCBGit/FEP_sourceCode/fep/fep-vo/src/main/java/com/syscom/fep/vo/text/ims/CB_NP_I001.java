...
public class CB_NP_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 8)
	private String BIRDAY = StringUtils.EMPTY;

    @Field(length = 10)
	private String PITELNO = StringUtils.EMPTY;

    @Field(length = 1)
	private String PINPFUN = StringUtils.EMPTY;

    @Field(length = 2)
	private String PIEBACLL = StringUtils.EMPTY;

    @Field(length = 13)
	private String PIEBNPAC = StringUtils.EMPTY;
	...
	public String getPITELNO(){
        return this.PITELNO;
	}

	public void setPITELNO(String PITELNO){
        this.PITELNO = PITELNO;
	}

	public String getPINPFUN(){
        return this.PINPFUN;
	}

	public void setPINPFUN(String PINPFUN){
        this.PINPFUN = PINPFUN;
	}

	public String getPIEBACLL(){
        return this.PIEBACLL;
	}

	public void setPIEBACLL(String PIEBACLL){
        this.PIEBACLL = PIEBACLL;
	}

	public String getPIEBNPAC(){
        return this.PIEBNPAC;
	}

	public void setPIEBNPAC(String PIEBNPAC){
        this.PIEBNPAC = PIEBNPAC;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setBIRDAY(EbcdicConverter.fromHex(CCSID.English,tita.substring(496, 512)));
        this.setPITELNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(512, 532)));
        this.setPINPFUN(EbcdicConverter.fromHex(CCSID.English,tita.substring(532, 534)));
        this.setPIEBACLL(EbcdicConverter.fromHex(CCSID.English,tita.substring(534, 538)));
        this.setPIEBNPAC(EbcdicConverter.fromHex(CCSID.English,tita.substring(538, 564)));
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getBIRDAY(), 8) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPITELNO(), 10) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPINPFUN(), 1) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPIEBACLL(), 2) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPIEBNPAC(), 13) //
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getBIRDAY(), StringUtils.EMPTY), 8," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPITELNO(), StringUtils.EMPTY), 10," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPINPFUN(), StringUtils.EMPTY), 1," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPIEBACLL(), StringUtils.EMPTY), 2," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPIEBNPAC(), StringUtils.EMPTY), 13," ") //
