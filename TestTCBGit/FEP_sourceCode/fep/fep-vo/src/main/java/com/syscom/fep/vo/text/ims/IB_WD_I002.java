...
public class IB_WD_I002 extends IMSTextBase {
    @Field(length = 8)
    ...
    public void parseCbsTele(String tita) throws ParseException {
        ...
        this.setTXNAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English, tita.substring(380, 408)), false, 2));
        this.setFROMACT(EbcdicConverter.fromHex(CCSID.English, tita.substring(408, 440)));
        this.setPINBLOCK(EbcdicConverter.fromHex(CCSID.English, tita.substring(440, 456)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English, tita.substring(456, 1200)));
    }
    ...
    public String makeMessage() {
        return "" //
                ...
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPINBLOCK(), 8) //
                + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 372) //
                ;
    }
    ...
    public String makeMessageAscii() {
        return "" //
                ...
                + StringUtils.leftPad(this.getPINBLOCK(), 8, " ") //
                + StringUtils.leftPad(this.getDRVS(), 372, " ") //
                ;
    }
}
