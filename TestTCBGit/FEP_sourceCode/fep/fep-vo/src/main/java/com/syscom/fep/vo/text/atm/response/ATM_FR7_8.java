...
public class ATM_FR7_8 extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 208;
	...
	public String makeMessage() {
		...
		this.setDATA(StringUtils.rightPad(this.getDATA(),170,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDATA(),170) +
