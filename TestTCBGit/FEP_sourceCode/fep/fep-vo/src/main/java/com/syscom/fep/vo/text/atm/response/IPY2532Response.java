...
@XStreamAlias("FEP")
public class IPY2532Response extends ATMXmlBase {
	@XStreamAlias("RsHeader")
	private FEPRsHeader rsHeader;
	@XStreamAlias("SvcRs")
	private IPY2532SvcRs svcRs;
	...
	public IPY2532SvcRs getSvcRs()
	{
		return svcRs;
	}
	public void setSvcRs(IPY2532SvcRs value)
	{
		svcRs = value;
	}
	...
	public String makeMessageFromGeneral(ATMGeneral general) throws Exception {
		...
		this.svcRs.setRs(new IPY2532Rs());
	...
	@XStreamAlias("SvcRs")
	public static class IPY2532SvcRs {
		@XStreamAlias("Rs")
		private IPY2532Rs rs;

		public IPY2532Rs getRs() {
			return rs;
		}

		public void setRs(IPY2532Rs rs) {
			this.rs = rs;
		}
	}

	@XStreamAlias("Rs")
	public static class IPY2532Rs {
		// 手續費-客戶負擔
