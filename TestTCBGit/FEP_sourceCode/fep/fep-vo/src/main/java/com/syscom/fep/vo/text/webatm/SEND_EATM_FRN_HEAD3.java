...
return "" //
                    ...
                    + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPROCSTA(), 3) //
                    + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getACTFG(), 1) //
                    + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getRVSFG(), 1) //
                    + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getERRCODE(), 4) //
;
}
}
