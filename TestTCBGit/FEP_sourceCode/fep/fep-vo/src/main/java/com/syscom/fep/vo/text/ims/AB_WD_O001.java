...
public class AB_WD_O001 extends IMSTextBase {
    ...
    @Field(length = 10)
	private String CID_NO = StringUtils.EMPTY;
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setCID_NO(EbcdicConverter.fromHex(CCSID.English,tita.substring(564, 584)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(584, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCID_NO(), 10) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 308) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCID_NO(), StringUtils.EMPTY), 10," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 308," ")
		;
	}
}
