...
public class ATM_FAA_CC1B2PN extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 236;
	...
	public String makeMessage() {
	    ...
	    if(this.getPFEE().equals(StringUtils.EMPTY)){
	    	this.setPFEE(StringUtils.leftPad("$0",6,StringUtils.SPACE));
	    }else{
			this.setPFEE(StringUtils.leftPad(this.getPFEE(),6,StringUtils.SPACE));
	    }    
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPFEE(),6) +
