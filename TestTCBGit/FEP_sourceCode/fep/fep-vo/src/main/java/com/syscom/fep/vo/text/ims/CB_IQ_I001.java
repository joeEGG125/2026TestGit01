...
public class CB_IQ_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 16)
	private String INQELSEACT = StringUtils.EMPTY;

    @Field(length = 3)
	private String I4_CDMBANK = StringUtils.EMPTY;
	...
	public String getINQELSEACT(){
        return this.INQELSEACT;
	}

	public void setINQELSEACT(String INQELSEACT){
        this.INQELSEACT = INQELSEACT;
	}

	public String getI4_CDMBANK(){
        return this.I4_CDMBANK;
	}

	public void setI4_CDMBANK(String I4_CDMBANK){
        this.I4_CDMBANK = I4_CDMBANK;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setINQELSEACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(520, 552)));
        this.setI4_CDMBANK(EbcdicConverter.fromHex(CCSID.English,tita.substring(552, 558)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(558, 1280)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getINQELSEACT(), 16) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getI4_CDMBANK(), 3) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 361) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getINQELSEACT(), StringUtils.EMPTY), 16," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getI4_CDMBANK(), StringUtils.EMPTY), 3," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 361," ") //
		;
	}
}
