...
public class IB_OE_I012 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 15)
        private String BIT36_EMERCHID = StringUtils.EMPTY;

    @Field(length = 14)
        private BigDecimal BIT36_OENTDAMT;

    @Field(length = 7)
        private BigDecimal BIT36_OETWNFEE;
    ...
    @Field(length = 7)
        private BigDecimal BIT36_OENTAFEE;

    @Field(length = 12)
        private BigDecimal BIT36_OGTXAMT;

    @Field(length = 7)
        private BigDecimal BIT36_OEFCAFEE;
    ...
    @Field(length = 300)
        ...
        public String getBIT36_EMERCHID(){
        return this.BIT36_EMERCHID;
        }
        public void setBIT36_EMERCHID(String BIT36_EMERCHID){
        this.BIT36_EMERCHID = BIT36_EMERCHID;
        }
        public BigDecimal getBIT36_OENTDAMT(){
        return this.BIT36_OENTDAMT;
        }
        public void setBIT36_OENTDAMT(BigDecimal BIT36_OENTDAMT){
        this.BIT36_OENTDAMT = BIT36_OENTDAMT;
        }
        public BigDecimal getBIT36_OETWNFEE(){
        return this.BIT36_OETWNFEE;
        }
        public void setBIT36_OETWNFEE(BigDecimal BIT36_OETWNFEE){
        this.BIT36_OETWNFEE = BIT36_OETWNFEE;
        }
        ...
        public BigDecimal getBIT36_OENTAFEE(){
        return this.BIT36_OENTAFEE;
        }
        public void setBIT36_OENTAFEE(BigDecimal BIT36_OENTAFEE){
        this.BIT36_OENTAFEE = BIT36_OENTAFEE;
        }
        ...
        public BigDecimal getBIT36_OEFCAFEE(){
        return this.BIT36_OEFCAFEE;
        }
        public void setBIT36_OEFCAFEE(BigDecimal BIT36_OEFCAFEE){
        this.BIT36_OEFCAFEE = BIT36_OEFCAFEE;
        }
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setBIT36_EMERCHID(EbcdicConverter.fromHex(CCSID.English,tita.substring(440, 470)));
        this.setBIT36_OENTDAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(470, 498).trim()), false, 2));
        this.setBIT36_OETWNFEE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(498, 512).trim()), false, 2));
        this.setBIT36_OGSLCRT(EbcdicConverter.fromHex(CCSID.English,tita.substring(512, 528)));
        this.setBIT36_TMSTAN1(EbcdicConverter.fromHex(CCSID.English,tita.substring(528, 548)));
        this.setBIT36_OENTAFEE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(548, 562).trim()), false, 2));
        this.setBIT36_OGTXAMT(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(562, 586).trim()), false, 2));
        this.setBIT36_OEFCAFEE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(586, 600).trim()), false, 2));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(600, 1200)));
}
...
return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getBIT36_EMERCHID(), 15) //
            + CodeGenUtil.bigDecimalToEbcdic(this.getBIT36_OENTDAMT(), 11, false, 2, true) //
            + CodeGenUtil.bigDecimalToEbcdic(this.getBIT36_OETWNFEE(), 5, false, 2, false) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getBIT36_OGSLCRT(), 8) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getBIT36_TMSTAN1(), 10) //
            + CodeGenUtil.bigDecimalToEbcdic(this.getBIT36_OENTAFEE(), 5, false, 2, false) //
            + CodeGenUtil.bigDecimalToEbcdic(this.getBIT36_OGTXAMT(), 10, false, 2, false) //
            + CodeGenUtil.bigDecimalToEbcdic(this.getBIT36_OEFCAFEE(), 5, false, 2, false) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 300) //
;
}
...
return "" //
            ...
            + StringUtils.leftPad(this.getBIT36_EMERCHID(), 15," ") //
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getBIT36_OENTDAMT(), 11, false, 2, true) //
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getBIT36_OETWNFEE(), 5, false, 2, false) //
            + StringUtils.leftPad(this.getBIT36_OGSLCRT(), 8," ") //
            + StringUtils.leftPad(this.getBIT36_TMSTAN1(), 10," ") //
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getBIT36_OENTAFEE(), 5, false, 2, false) //
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getBIT36_OGTXAMT(), 10, false, 2, false) //
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getBIT36_OEFCAFEE(), 5, false, 2, false) //
            + StringUtils.leftPad(this.getDRVS(), 300," ") //
;
}
}
