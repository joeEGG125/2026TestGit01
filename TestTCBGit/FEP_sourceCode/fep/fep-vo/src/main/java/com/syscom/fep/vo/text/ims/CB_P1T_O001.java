...
public class CB_P1T_O001 extends IMSTextBase {
    ...
    @Field(length = 2)
	private String CARDSEQ = StringUtils.EMPTY;

    @Field(length = 1)
	private String PRCRDACT = StringUtils.EMPTY;

    @Field(length = 104)
	private String T3DATA = StringUtils.EMPTY;
	...
	public void setT3DATA(String T3DATA){
        this.T3DATA = T3DATA;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setCARDSEQ(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 530)));
        this.setPRCRDACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(530, 532)));
        this.setT3DATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(532, 740)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(740, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCARDSEQ(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPRCRDACT(), 1) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getT3DATA(), 104) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 230) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCARDSEQ(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPRCRDACT(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getT3DATA(), StringUtils.EMPTY), 104," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 230," ")
		;
	}
}
