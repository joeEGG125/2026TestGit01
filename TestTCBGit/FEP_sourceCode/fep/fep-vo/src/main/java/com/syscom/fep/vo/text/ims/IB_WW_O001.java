...
public class IB_WW_O001 extends IMSTextBase {
    ...
    @Field(length = 1)
	private String CIWAFLG = StringUtils.EMPTY;

    @Field(length = 7)
	private BigDecimal B006RATE;

    @Field(length = 30)
	private String RVTXNUSE = StringUtils.EMPTY;
	...
	public String getCIWAFLG(){
        return this.CIWAFLG;
	}
	
	public void setCIWAFLG(String CIWAFLG){
        this.CIWAFLG = CIWAFLG;
	}
	
	public BigDecimal getB006RATE(){
        return this.B006RATE;
	}
	
	public void setB006RATE(BigDecimal B006RATE){
        this.B006RATE = B006RATE;
	}
	
	public String getRVTXNUSE(){
        return this.RVTXNUSE;
	}
	
	public void setRVTXNUSE(String RVTXNUSE){
        this.RVTXNUSE = RVTXNUSE;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setCIWAFLG(EbcdicConverter.fromHex(CCSID.English,tita.substring(570, 572)));
        this.setB006RATE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(572, 586)).trim(), false, 4));
        this.setRVTXNUSE(EbcdicConverter.fromHex(CCSID.English,tita.substring(586, 646)));
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCIWAFLG(), 1) 
            + CodeGenUtil.bigDecimalToEbcdic(this.getB006RATE(), 3, false, 4, false) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getRVTXNUSE(), 30) 
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getAUTHCD(), StringUtils.EMPTY), 8," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCIWAFLG(), StringUtils.EMPTY), 1," ")
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getB006RATE(), 3, false, 4, false)
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getRVTXNUSE(), StringUtils.EMPTY), 30," ")
