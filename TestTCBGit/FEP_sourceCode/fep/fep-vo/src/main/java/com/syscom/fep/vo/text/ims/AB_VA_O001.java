...
public class AB_VA_O001 extends IMSTextBase {
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(550, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 325) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 325," ")
		;
	}
}
