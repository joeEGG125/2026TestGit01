...
public class ATM_FR9 extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 486;
	...
	public String makeMessage() {
		...
		this.setD0DATA(StringUtils.rightPad(this.getD0DATA(),38,StringUtils.SPACE));
	    this.setFR9DATA(StringUtils.rightPad(this.getFR9DATA(),408, "40"));
		this.setS1(StringUtils.rightPad(this.getS1(),2,StringUtils.SPACE));
