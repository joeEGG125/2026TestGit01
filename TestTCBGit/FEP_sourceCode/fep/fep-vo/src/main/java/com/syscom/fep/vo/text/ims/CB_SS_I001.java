...
public class CB_SS_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 1)
	private String CARD_TYPE = StringUtils.EMPTY;
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFACODE(EbcdicConverter.fromHex(CCSID.English,tita.substring(440, 444)));
        this.setBIRTHDAY(EbcdicConverter.fromHex(CCSID.English,tita.substring(444, 460)));
        this.setCARD_TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(460, 462)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(462, 1200)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFACODE(), 2) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getBIRTHDAY(), 8) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCARD_TYPE(), 1) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 369) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFACODE(), StringUtils.EMPTY), 2," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getBIRTHDAY(), StringUtils.EMPTY), 8," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCARD_TYPE(), StringUtils.EMPTY), 1," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 369," ") //
		;
	}
}
