...
public class AB_PY_EAI_O001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setTOACT006(EbcdicConverter.fromHex(CCSID.English,tita.substring(568, 594)));
        this.setTR_ACT_006(EbcdicConverter.fromHex(CCSID.English,tita.substring(594, 598)));
