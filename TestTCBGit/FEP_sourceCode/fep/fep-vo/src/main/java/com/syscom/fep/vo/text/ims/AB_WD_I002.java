...
public class AB_WD_I002 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFROMACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(240, 272)));
        this.setATMSTATUS_CODE(EbcdicConverter.fromHex(CCSID.English,tita.substring(272, 276)));
        this.setRVSTXAMT(EbcdicConverter.fromHex(CCSID.English,tita.substring(276, 304)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(304, 1200)));
	}
	...
	public String makeMessage() {
		return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 448) //
		;
	}
	...
	public String makeMessageAscii() {
		return "" //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 448," ") //
		;
	}
}
