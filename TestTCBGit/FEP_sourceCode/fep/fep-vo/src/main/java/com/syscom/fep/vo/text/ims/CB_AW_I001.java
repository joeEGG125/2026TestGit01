...
public class CB_AW_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 8)
	private String PIAWMAC = StringUtils.EMPTY;
	...
	public String getPIAWMAC(){
        return this.PIAWMAC;
	}

	public void setPIAWMAC(String PIAWMAC){
        this.PIAWMAC = PIAWMAC;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPIAWMAC(EbcdicConverter.fromHex(CCSID.English,tita.substring(532, 548)));
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPIAWMAC(), 8) //
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPIAWMAC(), StringUtils.EMPTY), 8," ") //
