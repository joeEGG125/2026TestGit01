...
public class IB_XI_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 80)
	private String FXMLMEMO = StringUtils.EMPTY;
	...
	public void setFXMLMEMO(String FXMLMEMO){
        this.FXMLMEMO = FXMLMEMO;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
		...
		this.setFXMLMEMO(tita.substring(824, 984));
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(1028, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 86) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTransferee_Bank_ID(), StringUtils.EMPTY), 7," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTransferor_Bank_ID(), StringUtils.EMPTY), 7," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 86," ")
		;
	}
}
