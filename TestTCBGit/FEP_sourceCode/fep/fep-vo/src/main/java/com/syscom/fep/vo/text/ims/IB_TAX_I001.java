...
public class IB_TAX_I001 extends IMSTextBase {
    @Field(length = 8)
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(582, 1200)));
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 309) //
;
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.leftPad(this.getDRVS(), 309," ") //
;
}
}
