...
public class CB_FCA_I001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 2)
	private String PITDRSEQ = StringUtils.EMPTY;
	...
	public String getPITDRSEQ(){
        return this.PITDRSEQ;
	}

	public void setPITDRSEQ(String PITDRSEQ){
        this.PITDRSEQ = PITDRSEQ;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setPITDRSEQ(EbcdicConverter.fromHex(CCSID.English,tita.substring(440, 444)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(444, 1200)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPITDRSEQ(), 2) //
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 378) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getPITDRSEQ(), StringUtils.EMPTY), 2," ") //
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 378," ") //
		;
	}
}
