...
public class IB_PEND_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 4)
	private String ORG_TX_PCODE = StringUtils.EMPTY;

    @Field(length = 7)
	private String ORG_TX_BUSINESS_DATE = StringUtils.EMPTY;

    @Field(length = 1)
	private String ORG_TX_ACCT_FLAG = StringUtils.EMPTY;

    @Field(length = 1)
	private String ORG_TX_RVS_FLAG = StringUtils.EMPTY;
	...
	public String getORG_TX_PCODE(){
        return this.ORG_TX_PCODE;
	}
	
	public void setORG_TX_PCODE(String ORG_TX_PCODE){
        this.ORG_TX_PCODE = ORG_TX_PCODE;
	}
	
	public String getORG_TX_BUSINESS_DATE(){
        return this.ORG_TX_BUSINESS_DATE;
	}
	
	public void setORG_TX_BUSINESS_DATE(String ORG_TX_BUSINESS_DATE){
        this.ORG_TX_BUSINESS_DATE = ORG_TX_BUSINESS_DATE;
	}
	
	public String getORG_TX_ACCT_FLAG(){
        return this.ORG_TX_ACCT_FLAG;
	}
	
	public void setORG_TX_ACCT_FLAG(String ORG_TX_ACCT_FLAG){
        this.ORG_TX_ACCT_FLAG = ORG_TX_ACCT_FLAG;
	}
	
	public String getORG_TX_RVS_FLAG(){
        return this.ORG_TX_RVS_FLAG;
	}
	
	public void setORG_TX_RVS_FLAG(String ORG_TX_RVS_FLAG){
        this.ORG_TX_RVS_FLAG = ORG_TX_RVS_FLAG;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setORG_TX_STAN(EbcdicConverter.fromHex(CCSID.English,tita.substring(200, 220)));
        this.setORG_TX_PCODE(EbcdicConverter.fromHex(CCSID.English,tita.substring(220, 228)));
        this.setORG_TX_BUSINESS_DATE(EbcdicConverter.fromHex(CCSID.English,tita.substring(228, 242)));
        this.setORG_TX_ACCT_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(242, 244)));
        this.setORG_TX_RVS_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(244, 246)));
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getORG_TX_PCODE(), 4) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getORG_TX_BUSINESS_DATE(), 7) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getORG_TX_ACCT_FLAG(), 1) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getORG_TX_RVS_FLAG(), 1) 
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getORG_TX_PCODE(), StringUtils.EMPTY), 4," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getORG_TX_BUSINESS_DATE(), StringUtils.EMPTY), 7," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getORG_TX_ACCT_FLAG(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getORG_TX_RVS_FLAG(), StringUtils.EMPTY), 1," ")
