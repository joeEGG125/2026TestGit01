...
public class AB_TAX_EAI_I001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setAE_TRNSFROUTNOTE(EbcdicConverter.fromHex(CCSID.English,tita.substring(610, 754)));
        this.setAE_AEISLLTY(EbcdicConverter.fromHex(CCSID.English,tita.substring(754, 756)));
        this.setAE_LIMITTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(756, 760)));
        this.setAE_AEIFIXFE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(760, 764).trim()), false, 0));
        this.setAE_AEINETFE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(764, 768).trim()), false, 0));
        this.setAE_AEIEDIFE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(768, 772).trim()), false, 0));
        this.setAE_AEICIRCU(EbcdicConverter.fromHex(CCSID.English,tita.substring(772, 796)));
        this.setAE_FMMBR(EbcdicConverter.fromHex(CCSID.English,tita.substring(796, 804)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(804, 1308)));
	}
	...
	public String makeMessage() {
        ...
        + this.getAE_TRNSFROUTNOTE()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 252) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getAE_TRNSFROUTNOTE()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 252," ") //
		;
	}
}
