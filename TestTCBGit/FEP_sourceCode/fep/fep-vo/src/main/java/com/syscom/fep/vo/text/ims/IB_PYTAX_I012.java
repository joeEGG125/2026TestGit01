...
public class IB_PYTAX_I012 extends IMSTextBase {
    @Field(length = 8)
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(408, 1200)));
}
...
return "" //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 396) //
;
}
...
return "" //
            ...
            + StringUtils.leftPad(this.getDRVS(), 396," ") //
;
}
}
