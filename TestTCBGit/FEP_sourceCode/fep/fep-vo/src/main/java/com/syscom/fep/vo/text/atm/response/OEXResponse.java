...
public class OEXResponse extends ATMTextBase {
	// 交易類別
	@Field(length = 6)
	...
	//
	@Field(length = 1392, optional = true)
	 ...
	 * MODE
	 * 
	 * 1: Online MODE2: Half Online MODE3: Night MODE4: Reentry MODE5:Go to Online MODE</remark>
	 */
	...
	*/
	...
	public String makeMessageFromGeneral(ATMGeneral general) throws Exception {
		...
		this._FILLER1 = StringUtil.toHex(StringUtils.leftPad("", 696, StringUtils.SPACE));//
		return StringUtils.join(this._TXCD_O, this._DATE, this._TIME, this._ATMNO_O, this._MODE_O, this._DD_O, this._DEPMODE_O, this._ATMSEQ_O1, this._ATMSEQ_O2, this._REJCD, this._FILLER1);
		*/return "";
    }
