...
public class CB_FS_I001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setTR_SPECIAL_FLAG(EbcdicConverter.fromHex(CCSID.English,tita.substring(472, 476)));
        ...
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(532, 1200)));
	}
	...
	public String makeMessage() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 334) //
		;
	}
	...
	public String makeMessageAscii() {
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 334," ") //
		;
	}
}
