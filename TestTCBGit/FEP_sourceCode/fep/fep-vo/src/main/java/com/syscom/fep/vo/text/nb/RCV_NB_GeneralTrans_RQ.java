...
public class RCV_NB_GeneralTrans_RQ extends NbXmlBase {
    ...
    public static class RCV_NB_GeneralTrans_RQ_Body_MsgRq_SvcRq {
        ...
        private RCV_NB_GeneralTrans_RQ_Body_MsgRq_FXMLDATA FXMLDATA;
        ...
        public RCV_NB_GeneralTrans_RQ_Body_MsgRq_FXMLDATA getFXMLDATA() {
            return FXMLDATA;
        }
        public void setFXMLDATA(RCV_NB_GeneralTrans_RQ_Body_MsgRq_FXMLDATA FXMLDATA) {
            this.FXMLDATA = FXMLDATA;
        }
    ...
    @XStreamAlias("FXMLDATA")
    public static class RCV_NB_GeneralTrans_RQ_Body_MsgRq_FXMLDATA {
        private String TRNSFRINNAME; // 非CODEGEN產生
        private String FXMLMEMO; // 非CODEGEN產生
        private String TRINNAME; // 非CODEGEN產生
        private String TROUTNAME; // 非CODEGEN產生

        public String getTRNSFRINNAME(){
            return this.TRNSFRINNAME;
        } // 非CODEGEN產生
        public void setTRNSFRINNAME(String value) {
            this.TRNSFRINNAME = value;
        }
        public String getFXMLMEMO(){
            return this.FXMLMEMO;
        } // 非CODEGEN產生
        public void setFXMLMEMO(String value) {
            this.FXMLMEMO = value;
        }
        public String getTRINNAME(){
            return this.TRINNAME;
        } // 非CODEGEN產生
        public void setTRINNAME(String value) {
            this.TRINNAME = value;
        }
        public String getTROUTNAME(){
            return this.TROUTNAME;
        } // 非CODEGEN產生
        public void setTROUTNAME(String value) {
            this.TROUTNAME = value;
        }
    }
