...
public class AB_TR_EAI_O001 extends IMSTextBase {
    @Field(length = 8)
    ...
    @Field(length = 2)
	private String FEEPAYMENTTYP = StringUtils.EMPTY;

    @Field(length = 4)
	private String CROSSFEE = StringUtils.EMPTY;

    @Field(length = 2)
	private String CHAFEEAMT = StringUtils.EMPTY;

    @Field(length = 14)
	private BigDecimal TRANSAMTOUT;

    @Field(length = 1)
	private String TRTOCIRCU = StringUtils.EMPTY;

    @Field(length = 4)
	private String CLEANBRANCHOUT = StringUtils.EMPTY;

    @Field(length = 13)
	private String TOACT006 = StringUtils.EMPTY;

    @Field(length = 2)
	private String TR_ACT_006 = StringUtils.EMPTY;

    @Field(length = 16)
	private String SA_ACT = StringUtils.EMPTY;
	...
	public String getFEEPAYMENTTYP(){
        return this.FEEPAYMENTTYP;
	}
	
	public void setFEEPAYMENTTYP(String FEEPAYMENTTYP){
        this.FEEPAYMENTTYP = FEEPAYMENTTYP;
	}
	
	public String getCROSSFEE(){
        return this.CROSSFEE;
	}
	
	public void setCROSSFEE(String CROSSFEE){
        this.CROSSFEE = CROSSFEE;
	}
	
	public String getCHAFEEAMT(){
        return this.CHAFEEAMT;
	}
	
	public void setCHAFEEAMT(String CHAFEEAMT){
	...
	public String getTRTOCIRCU(){
        return this.TRTOCIRCU;
	}
	
	public void setTRTOCIRCU(String TRTOCIRCU){
        this.TRTOCIRCU = TRTOCIRCU;
	}
	...
	public String getTOACT006(){
        return this.TOACT006;
	}
	
	public void setTOACT006(String TOACT006){
        this.TOACT006 = TOACT006;
	}
	
	public String getTR_ACT_006(){
        return this.TR_ACT_006;
	}
	
	public void setTR_ACT_006(String TR_ACT_006){
        this.TR_ACT_006 = TR_ACT_006;
	}
	
	public String getSA_ACT(){
        return this.SA_ACT;
	}
	
	public void setSA_ACT(String SA_ACT){
        this.SA_ACT = SA_ACT;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setFEEPAYMENTTYP(EbcdicConverter.fromHex(CCSID.English,tita.substring(586, 590)));
        this.setCROSSFEE(EbcdicConverter.fromHex(CCSID.English,tita.substring(590, 598)));
        this.setCHAFEEAMT(EbcdicConverter.fromHex(CCSID.English,tita.substring(598, 602)));
        ...
        this.setTRTOCIRCU(EbcdicConverter.fromHex(CCSID.English,tita.substring(630, 632)));
        this.setCLEANBRANCHOUT(EbcdicConverter.fromHex(CCSID.English,tita.substring(632, 640)));
        this.setTOACT006(EbcdicConverter.fromHex(CCSID.English,tita.substring(640, 666)));
        this.setTR_ACT_006(EbcdicConverter.fromHex(CCSID.English,tita.substring(666, 670)));
        this.setSA_ACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(670, 702)));
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getFEEPAYMENTTYP(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCROSSFEE(), 4) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCHAFEEAMT(), 2) 
            + CodeGenUtil.bigDecimalToEbcdic(this.getTRANSAMTOUT(), 11, false, 2, true) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTRTOCIRCU(), 1) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getCLEANBRANCHOUT(), 4) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTOACT006(), 13) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getTR_ACT_006(), 2) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getSA_ACT(), 16) 
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getFEEPAYMENTTYP(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCROSSFEE(), StringUtils.EMPTY), 4," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCHAFEEAMT(), StringUtils.EMPTY), 2," ")
            + CodeGenUtil.bigDecimalToAsciiCBS(this.getTRANSAMTOUT(), 11, false, 2, true)
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTRTOCIRCU(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getCLEANBRANCHOUT(), StringUtils.EMPTY), 4," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTOACT006(), StringUtils.EMPTY), 13," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getTR_ACT_006(), StringUtils.EMPTY), 2," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getSA_ACT(), StringUtils.EMPTY), 16," ")
