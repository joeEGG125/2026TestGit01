...
public class IB_UHT1_O001 extends IMSTextBase {
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getO_FILLER_TR(), StringUtils.EMPTY), 12," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 211," ")
		;
	}
}
