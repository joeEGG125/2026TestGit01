...
public class CB_FV_I001 extends IMSTextBase {
    @Field(length = 8)
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setCUSTID(EbcdicConverter.fromHex(CCSID.English,tita.substring(272, 292)));
        this.setFVDATA(EbcdicConverter.fromHex(CCSID.English,tita.substring(292, 1108)));
