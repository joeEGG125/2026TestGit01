...
public class AB_VA_I001 extends IMSTextBase {
    ...
    @Field(length = 16)
	private String EIPYAC2 = StringUtils.EMPTY;
	...
	public String getEIPYAC2(){
        return this.EIPYAC2;
	}
	
	public void setEIPYAC2(String EIPYAC2){
        this.EIPYAC2 = EIPYAC2;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setIDNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(456, 476)));
        this.setCLCPYCI(EbcdicConverter.fromHex(CCSID.English,tita.substring(476, 492)));
        this.setPAYUNTNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(492, 508)));
        this.setTAXTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(508, 518)));
        this.setPAYFEENO(EbcdicConverter.fromHex(CCSID.English,tita.substring(518, 526)));
        this.setMOBILENO(EbcdicConverter.fromHex(CCSID.English,tita.substring(526, 546)));
        this.setEIPYAC2(EbcdicConverter.fromHex(CCSID.English,tita.substring(546, 578)));
        this.setAEIPYAC(EbcdicConverter.fromHex(CCSID.English,tita.substring(578, 610)));
        this.setINSURE_IDNO(EbcdicConverter.fromHex(CCSID.English,tita.substring(610, 630)));
        this.setAEIPYBK(EbcdicConverter.fromHex(CCSID.English,tita.substring(630, 636)));
        this.setAEIPYBH(EbcdicConverter.fromHex(CCSID.English,tita.substring(636, 644)));
        this.setSSLTYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(644, 646)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(646, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getEIPYAC2(), 16) 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 277) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getEIPYAC2(), StringUtils.EMPTY), 16," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 277," ")
		;
	}
}
