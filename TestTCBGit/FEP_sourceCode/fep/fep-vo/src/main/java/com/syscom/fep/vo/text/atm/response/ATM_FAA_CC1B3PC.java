...
public class ATM_FAA_CC1B3PC extends ATMTextBase {
	@Field(length = 5)
	...
	private static final int _TotalLength = 267;
	...
	public void setPEXRATE(String PEXRATE){
		this.PEXRATE = PEXRATE;
	}
	...
	public void setPTMEXNO(String PTMEXNO){
		this.PTMEXNO = PTMEXNO;
	}
	...
	public String makeMessage() {
	    ...
	    if(this.getPEXRATE().equals(StringUtils.EMPTY)){
	    	this.setPEXRATE(StringUtils.leftPad("$0",8,StringUtils.SPACE));
	    }else{
			this.setPEXRATE(StringUtils.leftPad(this.getPEXRATE(),8,StringUtils.SPACE));
	    }    
		this.setS18(StringUtils.rightPad(this.getS18(),2,StringUtils.SPACE));
	    if(this.getPAMT().equals(StringUtils.EMPTY)){
	    	this.setPAMT(StringUtils.leftPad("$0",11,StringUtils.SPACE));
	    }else{
			this.setPAMT(StringUtils.leftPad(this.getPAMT(),11,StringUtils.SPACE));
	    }    
		this.setS19(StringUtils.rightPad(this.getS19(),2,StringUtils.SPACE));
		this.setPTMEXNO(StringUtils.rightPad(this.getPTMEXNO(),12,StringUtils.SPACE));
		this.setS20(StringUtils.rightPad(this.getS20(),2,StringUtils.SPACE));
		this.setPARPC(StringUtils.rightPad(this.getPARPC(),16,StringUtils.SPACE));
		this.setS21(StringUtils.rightPad(this.getS21(),2,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPEXRATE(),8) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getS18(),2) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPAMT(),11) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getS19(),2) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPTMEXNO(),12) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getS20(),2) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getPARPC(),16) +
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getS21(),2) +
