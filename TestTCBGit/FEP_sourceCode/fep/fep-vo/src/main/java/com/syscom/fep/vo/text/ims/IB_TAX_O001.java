...
public class IB_TAX_O001 extends IMSTextBase {
	...
	public String makeMessageAscii() {
		return "" 
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getIMS_TAXANS(), StringUtils.EMPTY), 8," ")
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 316," ")
		;
	}
}
