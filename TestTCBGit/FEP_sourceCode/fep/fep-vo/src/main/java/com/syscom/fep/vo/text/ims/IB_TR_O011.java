...
public class IB_TR_O011 extends IMSTextBase {
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setHBKNO_TOACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(586, 612)));
        this.setTR_TYPE(EbcdicConverter.fromHex(CCSID.English,tita.substring(612, 616)));
        this.setSA_ACT(EbcdicConverter.fromHex(CCSID.English,tita.substring(616, 648)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(648, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 276) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 276," ")
		;
	}
}
