...
public class IB_UHT3_I001 extends IMSTextBase {
    @Field(length = 8)
...
public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setBIT35_JRNATION(EbcdicConverter.fromHex(CCSID.English,tita.substring(560, 566)));
        this.setBIT35_JRCCD(EbcdicConverter.fromHex(CCSID.English,tita.substring(566, 572)));
        this.setBIT35_JTAIFEE(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(572, 586).trim()), false, 0));
        this.setBIT35_WAMTDISP(CodeGenUtil.asciiToBigDecimal(EbcdicConverter.fromHex(CCSID.English,tita.substring(586, 614).trim()), false, 2));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(614, 1200)));
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 293) //
;
}
...
return "" //
        ...
        + this.getTXNICCTAC()  //
            ...
            + StringUtils.leftPad(this.getDRVS(), 293," ") //
;
}
}
