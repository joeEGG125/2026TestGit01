...
public class AB_WW_I002 extends IMSTextBase {
    ...
    @Field(length = 14)
	private String RVSTXAMT = StringUtils.EMPTY;

    @Field(length = 1)
	private String EMVARPCRC = StringUtils.EMPTY;
	...
	public String getRVSTXAMT(){
        return this.RVSTXAMT;
	}
	
	public void setRVSTXAMT(String RVSTXAMT){
        this.RVSTXAMT = RVSTXAMT;
	}
	
	public String getEMVARPCRC(){
        return this.EMVARPCRC;
	}
	
	public void setEMVARPCRC(String EMVARPCRC){
        this.EMVARPCRC = EMVARPCRC;
	}
	...
	public void parseCbsTele(String tita) throws ParseException{
        ...
        this.setRVSTXAMT(EbcdicConverter.fromHex(CCSID.English,tita.substring(282, 310)));
        this.setEMVARPCRC(EbcdicConverter.fromHex(CCSID.English,tita.substring(310, 312)));
        this.setDRVS(EbcdicConverter.fromHex(CCSID.English,tita.substring(312, 1200)));
	}
	...
	public String makeMessage() {
		return "" 
            ...
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getRVSTXAMT(), 14) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getEMVARPCRC(), 1) 
            + CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getDRVS(), 444) 
		;
	}
	...
	public String makeMessageAscii() {
		return "" 
			...
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getRVSTXAMT(), StringUtils.EMPTY), 14," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getEMVARPCRC(), StringUtils.EMPTY), 1," ")
			+ StringUtils.rightPad(StringUtils.defaultIfEmpty(this.getDRVS(), StringUtils.EMPTY), 444," ")
		;
	}
}
