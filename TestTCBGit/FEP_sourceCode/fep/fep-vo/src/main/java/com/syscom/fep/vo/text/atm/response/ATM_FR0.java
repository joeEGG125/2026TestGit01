...
public class ATM_FR0 extends ATMTextBase {
	@Field(length = 5)
	...
	@Field(length = 2)
	private String ACTTYPE = StringUtils.EMPTY;
	...
	private static final int _TotalLength = 218;
	...
	public String makeMessage() {
	    ...
	    this.setACTNAME(StringUtils.rightPad(this.getACTNAME(),208, "40"));
		this.setD5(StringUtils.rightPad(this.getD5(),2,StringUtils.SPACE));
		this.setACTTYPE(StringUtils.rightPad(this.getACTTYPE(),2,StringUtils.SPACE));
		...
		return CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getWSID(),5) +
		      ...
		      CodeGenUtil.asciiToEbcdicDefaultEmpty(this.getACTTYPE(),2) +
