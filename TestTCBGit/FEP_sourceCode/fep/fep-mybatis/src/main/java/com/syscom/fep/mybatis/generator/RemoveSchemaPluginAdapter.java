...
public class RemoveSchemaPluginAdapter extends PluginAdapter {
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        if (StringUtils.isNotBlank(schema)) {
            ...
            searchString = StringUtils.join(Arrays.asList(schema, MybatisConstant.REPLACE_TABLE_NAME_FOR_FEPTXN01), ".");
            this.removeSchema(document.getRootElement(), MybatisConstant.REPLACE_TABLE_NAME_FOR_FEPTXN01, searchString);
        }
        return true;
    }
