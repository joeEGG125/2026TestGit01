...
public class PAYConfirmI extends INBKAABase {
     ...
     * @throws Exception PAYConfirmIException
     */
    ...
    private FEPReturnCode checkBusinessRule() {
        ...
        try {
            ...
            if(getFiscBusiness().getFeptxntcb() == null) {
                return FEPReturnCode.MessageFormatError; //**相關欄位檢查錯誤
            }
            ...
            if (rtnCode != FEPReturnCode.Normal) {
                ...
                return FEPReturnCode.ENCCheckMACError; //**0302:訊息押碼錯誤
            }
            return rtnCode;
        } catch (Exception ex) {
            getLogContext().setProgramException(ex);
        ...
        if (NormalRC.FISC_ATM_OK.equals(getFiscBusiness().getFeptxn().getFeptxnRepRc())) { /* +REP */
            if (!NormalRC.FISC_ATM_OK.equals(getFiscBusiness().getFeptxn().getFeptxnConRc())) {
                ...
                if (SysStatus.getPropertyValue().getSysstatHbkno().equals(getFiscBusiness().getFeptxn().getFeptxnTroutBkno())) {
                    ...
                    /* 2261/2264/2561/2564 轉入, -CON送交易結束通知(END)給主機 */
                ...
                /* +CON */
                /* 轉入交易入帳 */
                /* 2023/5/23 修改 2261/2264/2561/2564 轉入 + CON 送CBS 入帳 */
                /* 2025/7/22 修改,  2263 + CON 不需送CBS 入帳  */
                if( !getFiscBusiness().getFeptxn().getFeptxnTroutBkno().equals(SysStatus.getPropertyValue().getSysstatHbkno())
                    ...
                    /* 2262/2263/2264/2562/2563/2564/2568/2569轉出, + CON 送交易結束通知(END)給主機*/
                    rtnCode = this.SendToCBSEnd();
                }
            }
        }
