...
import com.syscom.fep.vo.text.webatm.SEND_EATM_FCC_FRC;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FCC_FRC.SEND_EATM_FCC_FRC_Body;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FCC_FRC.SEND_EATM_FCC_FRC_Body_MsgRs_Header;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FCC_FRC.SEND_EATM_FCC_FRC_Body_MsgRs_SvcRs;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FCC_FRC.SEND_EATM_FCC_FRC_Body_NS1MsgRs;
...
public class EATMFCCSelfIssue extends ATMPAABase {
    ...
    private String response() throws Exception {
        ...
        try {
            ...
            SEND_EATM_FCC_FRC rs = new SEND_EATM_FCC_FRC();
            SEND_EATM_FCC_FRC_Body rsbody = new SEND_EATM_FCC_FRC_Body();
            SEND_EATM_FCC_FRC_Body_NS1MsgRs msgrs = new SEND_EATM_FCC_FRC_Body_NS1MsgRs();
            SEND_EATM_FCC_FRC_Body_MsgRs_Header header = new SEND_EATM_FCC_FRC_Body_MsgRs_Header();
            SEND_EATM_FCC_FRC_Body_MsgRs_SvcRs body = new SEND_EATM_FCC_FRC_Body_MsgRs_SvcRs();
            ...
            body.setOUTDATA(this.getImsPropertiesValue(tota, ImsMethodName.D0_FCC.getValue()));
