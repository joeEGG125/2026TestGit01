 ...
 * @author
 */
public class NBTXOtherRequestA extends INBKAABase {
    ...
    public NBTXOtherRequestA(NBData txnData) throws Exception {
        super(txnData);
    }
    ...
    public String processRequestData() throws Exception {
        ...
        try {
            ...
            if(StringUtils.equals(getLogContext().getChannel().getNameS(),FEPChannel.VO.getNameS())){
                ...
                rtnMessage = getFiscBusiness().prepareNBTXResponseData(tota, getLogContext().getChannel());
            }
    ...
    private void updateTxData() {
        ...
        if (rtnCode == CommonReturnCode.Normal && rtnCode2 == CommonReturnCode.Normal && NormalRC.FISC_ATM_OK.equals(getFeptxn().getFeptxnRepRc())) { /*+REP*/
            ...
            if (!DbHelper.toBoolean(getTxData().getMsgCtl().getMsgctlFisc2way())) {
                rtnCode4 = getFiscBusiness().sendConfirmToFISC();
