...
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PC;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PC.SEND_EATM_FAA_CCP1PC_Body;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PC.SEND_EATM_FAA_CCP1PC_Body_MsgRs_Header;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PC.SEND_EATM_FAA_CCP1PC_Body_MsgRs_SvcRs;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PC.SEND_EATM_FAA_CCP1PC_Body_NS1MsgRs;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PN;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PN.SEND_EATM_FAA_CCP1PN_Body;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PN.SEND_EATM_FAA_CCP1PN_Body_MsgRs_Header;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PN.SEND_EATM_FAA_CCP1PN_Body_MsgRs_SvcRs;
import com.syscom.fep.vo.text.webatm.SEND_EATM_FAA_CCP1PN.SEND_EATM_FAA_CCP1PN_Body_NS1MsgRs;
...
public class EATMP1CSelfIssue extends ATMPAABase {
	...
	private void checkBusinessRule() throws Exception {
		...
		if (getTxData().getMsgCtl().getMsgctlReqmacType() != null) {
			...
			rtnCode = new ENCHelper(getTxData()).checkAtmMac(
					StringUtils.substring(getATMBusiness().getAtmTxData().getTxRequestMessage(), 151, 353),
					ATM_TITA_PICCMACD);
		}
	}
	...
	private String response() throws Exception {
		...
		try {
			...
			if (rtnCode != FEPReturnCode.Normal) {
				...
				SEND_EATM_FAA_CCP1PC rs = new SEND_EATM_FAA_CCP1PC();
				SEND_EATM_FAA_CCP1PC_Body rsbody = new SEND_EATM_FAA_CCP1PC_Body();
				SEND_EATM_FAA_CCP1PC_Body_NS1MsgRs msgrs = new SEND_EATM_FAA_CCP1PC_Body_NS1MsgRs();
				SEND_EATM_FAA_CCP1PC_Body_MsgRs_Header header = new SEND_EATM_FAA_CCP1PC_Body_MsgRs_Header();
				SEND_EATM_FAA_CCP1PC_Body_MsgRs_SvcRs body = new SEND_EATM_FAA_CCP1PC_Body_MsgRs_SvcRs();
				...
				body.setTDRSEG(atmReqbody.getTDRSEG()); // 回覆FR2
				
				body.setCARDACT("4"); //晶片)密碼變更
				...
				rfs.set("");
				rtnCode = atmEncHelper.makeAtmMac(XmlUtil.toXML(body), rfs);
				if (rtnCode != FEPReturnCode.Normal) {
				...
				SEND_EATM_FAA_CCP1PN rs = new SEND_EATM_FAA_CCP1PN();
				SEND_EATM_FAA_CCP1PN_Body rsbody = new SEND_EATM_FAA_CCP1PN_Body();
				SEND_EATM_FAA_CCP1PN_Body_NS1MsgRs msgrs = new SEND_EATM_FAA_CCP1PN_Body_NS1MsgRs();
				SEND_EATM_FAA_CCP1PN_Body_MsgRs_Header header = new SEND_EATM_FAA_CCP1PN_Body_MsgRs_Header();
				SEND_EATM_FAA_CCP1PN_Body_MsgRs_SvcRs body = new SEND_EATM_FAA_CCP1PN_Body_MsgRs_SvcRs();
				msgrs.setHeader(header);
				msgrs.setSvcRq(body);
				rsbody.setRs(msgrs);
				rs.setBody(rsbody);
